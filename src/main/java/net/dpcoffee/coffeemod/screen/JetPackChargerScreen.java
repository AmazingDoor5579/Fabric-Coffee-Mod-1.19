...
public class JetPackChargerScreen extends HandledScreen<JetPackChargerScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(CoffeeMod.MOD_ID, "textures/gui/staff_charger_gui.png");

    public JetPackChargerScreen(JetPackChargerScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext drawContext, float delta, int mouseX, int mouseY) {
        ...
        //drawTexture(drawContext.getMatrices(), x, y, 0, 0, backgroundWidth, backgroundHeight);
    ...
    private void renderCurrentCharge(DrawContext drawContext, int x, int y) {
        drawContext.drawTexture(TEXTURE, x + 116, y + 77, 192, 64, -8, -handler.getScaledProgressJetPackCharge());
    }
